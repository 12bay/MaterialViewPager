...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private final com.github.florent37.materialviewpager.PagerSlidingTabStrip.PagerAdapterObserver mAdapterObserver = new com.github.florent37.materialviewpager.PagerSlidingTabStrip.PagerAdapterObserver();
    private final com.github.florent37.materialviewpager.PagerSlidingTabStrip.PageListener mPageListener = new com.github.florent37.materialviewpager.PagerSlidingTabStrip.PageListener();
    private com.github.florent37.materialviewpager.PagerSlidingTabStrip.OnTabReselectedListener mTabReselectedListener = null;
    ...
    public void setViewPager(ViewPager pager) {
        ...
        isCustomTabs = pager.getAdapter() instanceof com.github.florent37.materialviewpager.PagerSlidingTabStrip.CustomTabProvider;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (isCustomTabs) {
                tabView = ((com.github.florent37.materialviewpager.PagerSlidingTabStrip.CustomTabProvider) mPager.getAdapter()).getCustomTabView(this, i);
            } else {
    ...
    public void setOnTabReselectedListener(com.github.florent37.materialviewpager.PagerSlidingTabStrip.OnTabReselectedListener tabReselectedListener) {
    ...
    private void unSelect(View tab) {
        if (tab != null) {
            ...
            if (isCustomTabs)
                ((com.github.florent37.materialviewpager.PagerSlidingTabStrip.CustomTabProvider) mPager.getAdapter()).tabUnselected(tab);
        }
    }
    ...
    private void select(View tab) {
        if (tab != null) {
            ...
            if (isCustomTabs)
                ((com.github.florent37.materialviewpager.PagerSlidingTabStrip.CustomTabProvider) mPager.getAdapter()).tabSelected(tab);
        }
    }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState savedState = (com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState) state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState savedState = new com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState> CREATOR = new Parcelable.Creator<com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState>() {
            @Override
            public com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState createFromParcel(Parcel in) {
                return new com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState(in);
            }

            @Override
            public com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState[] newArray(int size) {
                return new com.github.florent37.materialviewpager.PagerSlidingTabStrip.SavedState[size];
            }
        };
    }
